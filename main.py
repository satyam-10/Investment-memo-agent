...
Usage:
    python main.py
    (you'll be prompted for a ticker)

    python main.py AAPL

The four research agents run concurrently. The memo writer composes them,
the critic reviews, and you (the human) approve or send back for revision.
"""
...
def gather_research(client, snapshot: dict) -> dict:
    ...
    with ThreadPoolExecutor(max_workers=4) as pool:
        ...
        f_market = pool.submit(run_market_research, client, ticker, company_name)
